...
const Sales = () => {
  ...
  const  data1 = useMemo(() => [
    ...
    { heading: 'CLOUD SECURITY', description: 'Android app penetration testing evaluates Android mobile apps for vulnerabilities in code, data storage, and communication protocols, enhancing app security.', image: './Assets/slides/sl-3.png' },
  ], [])
